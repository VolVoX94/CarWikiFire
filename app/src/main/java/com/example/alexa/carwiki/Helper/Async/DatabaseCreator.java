...
/**
 * Created by mathi on 23.04.2018.
 */

//This is just for test purposes - The Room database implements a singleton by default
    ...
    public void createDb(Context context) {
        ...
        new AsyncTask<Context, Void, Void>() {
            ...
            protected Void doInBackground(Context... params) {
                ...
                context.deleteDatabase("production");

                // Build the database!
                AppDatabase db = Room.databaseBuilder(context.getApplicationContext(),
                        AppDatabase.class, "production").build();
